...
<div class="row mb-3 text-center">
    <div class="col-6 themed-grid-col border-end">
        <div id="vehiculoContainer" class="row justify-content-center">
            <div class="col-12 col-md-6 w-100">
                <div class="container d-flex flex-wrap align-items-center w-75 py-3">
                    <h3 class="d-flex align-items-center my-lg-0 me-lg-auto text-white text-decoration-none px-0">
                        {{ $vehiculo->marca}} {{$vehiculo->modelo}}
                    </h3>
                    <div class="d-flex align-items-end">
                        <h3 class="m-0 px-0" style="color:#E50914;">${{$vehiculo->precio}}</h3>
                    </div>
                </div>
    ...
    <div class="col-6 themed-grid-col bg-dark align-content-center">
        <div>
            <h2>Para contactar con dueño del vehículo</h2>
        </div>
        <div>
