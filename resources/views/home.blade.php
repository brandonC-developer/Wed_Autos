...
<div class="mx-0">
    ...
    <div class="row text-center align-items-center m-0" style="height: 70vh;">
        ...
        <div class="col-6 col-xxl-4 themed-grid-col h-100 d-flex flex-column justify-content-center align-items-center"
            ...
            <form class="text-start w-75" action="{{ url('/vehiculo/buscar') }}" method="GET">
                <div class="mb-3">
...
<div class="jumbotron bg-transparent text-center">
    ...
    <a href="{{ url('/vehiculo/buscar') }}" class="btn btn-primary btn-lg">Buscar Vehículos</a>
    <a href="{{ url('/login') }}"  class="btn btn-secondary btn-lg">Registrar Vehículo</a>
</div>
